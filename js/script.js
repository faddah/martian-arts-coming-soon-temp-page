...
var logo_scale = 20; // Logo sale factor (in percents)
...
var logo_url = "https://www.facebook.com/MartianArtsTattooStudio"; // Specify URL when clicking on logo
...
function counter_start() {
	...
	austDay = new Date(austDay.getFullYear() + 0, 9 - 1, 23); // Examples: (austDay.getFullYear() + 1, 3 - 1, 6) or (2013, 3 - 1, 6)
